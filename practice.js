//We're in a job interview. Answer the following questions (try to not look at your notes unless you have to).
  // 1) What is the purpose of the 'this keyword'?
      ...
      //Answer
// it refers to a variable (a property), and makes a function useful for more than one object. Like a pronoun.
...
var prius = new Car('Toyota', 'Prius', 2011, 100);
var mustang = new Car('Ford', 'Mustang', 2013, 280);
...
//Note(no tests)
  //Answer Here
// it will log myUser's username after 5 seconds
